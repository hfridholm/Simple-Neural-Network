...
#include "../Neural-Engine-Folder/Header-Files-Folder/engine-include-header.h"
...
int main(int argc, char* argv[])
{
  ...
  fill_fmatarr_random(weights, layerAmount - 1, maxShape, maxShape, -1.0, +1.0);
  fill_fmatrix_random(biases, layerAmount - 1, maxShape, -1.0, +1.0);
  ...
  for(int epochIndex = 0; epochIndex < 1000; epochIndex += 1)
  {
